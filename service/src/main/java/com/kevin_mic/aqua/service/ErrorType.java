...
public enum ErrorType {
    ...
    InvalidDeviceType,
    SupplierCannotBeNull, ActionFieldCannotBeEmpty, CannotChangeActionType, ScheduleRequired, ScheduleDaysRequired, ScheduleDays_AllDaysCannotBeWithWeekDays, ScheduleOnOffTimesRequired, ScheduleOnOffTimesMaximumExceeded, ScheduleOnOffInvalid, ScheduleOnOff_OnOutOfOrder, ScheduleOnOff_On_Duplicate, ScheduleOnOff_On_OutOfOrder, ScheduleOnOff_Off_Duplicate, ScheduleOnOff_Off_ConflictsWithFirstOn, ScheduleOnOff_Off_OnlyTheLastOffCanBeBeforeOn, IntervalSchedule_InvalidRepeatInterval, IntervalSchedule_TimeUnitRequired, IntervalSchedule_MaxMinuteRepeatIntervalExceeded, IntervalSchedule_MaxHourRepeatIntervalExceeded,
}
