...
public class PinControllerTest {
    ...
    @After
    public void after() {
        verifyNoMoreInteractions(outputPin, pcf8574ProviderService, controller);
    }
    ...
    @Test
    public void test_on_raspi_defaultOn() {
        DevicePinSupplierJoin pin = getPin();
        pin.setDeviceDefaultOn(true);
    ...
    @Test
    public void test_off_raspi_defaultOn() {
        DevicePinSupplierJoin pin = getPin();
        pin.setDeviceDefaultOn(true);
    ...
    @Test
    public void test_on_pcf8574_defaultOn() {
        DevicePinSupplierJoin pin1 = getPin(1, PinSupplierType.PCF8574, "", true);
        DevicePinSupplierJoin pin2 = getPin(2, PinSupplierType.PCF8574A, "", true);
    ...
    @Test
    public void test_off_pcf8574_defaultOn() {
        DevicePinSupplierJoin pin1 = getPin(1, PinSupplierType.PCF8574, "", true);
        DevicePinSupplierJoin pin2 = getPin(2, PinSupplierType.PCF8574A, "", true);
    ...
    public void test_unprovisionPins() {
        ...
        verify(controller, times(3)).getProvisionedPin(anyString());
    ...
    private DevicePinSupplierJoin getPin(int pinId, PinSupplierType pinSupplierType, String pinHardwareId) {
        return getPin(pinId, pinSupplierType, pinHardwareId, false);
    }

    private DevicePinSupplierJoin getPin(int pinId, PinSupplierType pinSupplierType, String pinHardwareId, boolean defaultOn) {
        ...
        pin.setDeviceDefaultOn(defaultOn);
        return pin;
    }
}